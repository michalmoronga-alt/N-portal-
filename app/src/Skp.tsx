...
import type { Ack, AgentsState, MediaState, SketchUpState, UsageState, WeatherState } from './service';
...
interface Props {
  ...
  /** počasie pre riadok v páse (null = bez spojenia / nedostupné → riadok sa nezobrazí) */
