...
| **Ambientný režim (schválené 19. 9. 2026, mock `mock7.html`)** | Po 5 min bez dotyku v Station (nastaviteľné vypnuté/2/5/10): video pozadie `ambient.mp4` stmavené na 42 % (noc 22:00–7:00 na 22 %) prvých 30 min, potom statická snímka; veľké hodiny v strede s posunom každú minútu, malé kruhy usage s bodmi agentov vľavo dole, riadok skladby + equalizer cez celú šírku dole, štítok „čaká na teba“ hore. Dotyk vráti Station bez akcie; vypne sa aj pri prechode agenta do „čaká/hotovo“, pri AUTO prepnutí a pri výpadku spojenia. |
