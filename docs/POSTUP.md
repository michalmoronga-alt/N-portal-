...
**Aktuálne (15. 9. 2026 večer):** smer zmenený na PWA + lokálna služba ([SMER.md](SMER.md)). **E0 je hotové a prešlo na reálnom mobile** (služba `service/`, PWA `app/`, prijímač `sketchup/`): zameranie výberu, prázdny výber, viac objektov, a hlavne klávesnica aj myš zostávajú v SketchUpe bez klikania. **Ďalší krok: potvrdiť rozsah E1 (Station).**
